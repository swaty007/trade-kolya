                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown" style="margin-left: 10px">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            USDT: <strong><?= (double)Yii::$app->user->identity->USDT_money; ?></strong> <b
                                    class="caret"></b>
                        </a>
                            ...
                            <li>
                                <div class="text-center link-block">
                                    <button type="button" class="btn btn-w-m btn-primary" data-toggle="modal"
                                            data-target="#switchRate">Обмен средств
                                    </button>
                                </div>
                            </li>
                        </ul>
                    ...
                    <li style="margin-left: 10px">
                        <button type="button" class="btn btn-w-m btn-primary" data-toggle="modal"
                                data-target="#payments">Пополнить
                        </button>
                    </li>
                    <li style="margin-left: 10px">
                        <button type="button" class="btn btn-w-m btn-primary" data-toggle="modal"
                                data-target="#withdraw">Вывести
                        </button>
                    </li>
                    <li class="dropdown" style="margin-left: 10px">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                    ...
                    <li style="margin-left: 10px">
                        <div class="dropdown">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle styling-settings" href="#">
                                <span class="text-muted text-xs block"><?php echo Yii::$app->user->identity->username ?>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li>
                                    <form action="/site/logout" method="post">
                                        ...
                                        <button type="submit" class="btn btn-link logout"><i class="fa fa-sign-out"></i>
                                            Выйти
                                        </button>
                                    </form>
                                </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <small class="font-bold">Пополнением своего кошелька в нашей системе, вы получаете дополнительные
                    возможности
                </small>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="main-label" for="culture_main">Выберете валюту в которой хотите произвести
                        оплату:</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="text-am-cur"><span class="amount2"></span> <span class="currency2">BTC</span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<div class="modal inmodal" id="switchRate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="main-label" for="culture_main_switch1">Выберете валюту которую хотите списать с
                        баланса:</label>
                ...
                <div class="form-group">
                    <label class="main-label" for="culture_main_switch2">Выберете валюту в которую хотите перевести
                        деньги:</label>
...
<div class="modal inmodal" id="withdraw" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="main-label" for="culture_main_withdraw1">Выберете валюту которую хотите списать с
                        баланса:</label>
                ...
                <div class="form-group">
                    <label class="main-label" for="culture_main_withdraw2">Выберите валюту на которую хотите получить
                        деньги:</label>
                ...
                <div class="form-group">
                    ...
                    <input id="purse_withdraw" type="text" title="purse_withdraw" name="purse_withdraw"
                           style="width: 100%">
                </div>
            </div>
            <div class="modal-body hidden">
