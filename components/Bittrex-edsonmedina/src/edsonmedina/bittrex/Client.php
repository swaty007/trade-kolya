...
class Client
{
	...
	private function call ($method, $params = array(), $apiKey = false)
	{
         ...
         * 
         * @param type $market
         * @param type $tickInterval ("oneMin", "fiveMin", "thirtyMin", "hour" and "day")
         * @return type
         */
        public function GetTicks($market, $tickInterval = 'oneMin'){
                $apiVersion = 'v2.0';
                $this->baseUrl = 'https://bittrex.com/api/' . $apiVersion . '/';
                $params = array(
                    'marketName' => $market,
                    'tickInterval' => $tickInterval
                );
                
                return $this->call('pub/market/GetTicks', $params);
